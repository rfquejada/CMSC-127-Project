...
def show_admin_screen():
    ...
    logout_button.grid(row=0, column=1, sticky='ne', padx=650, pady=20)

    
    # Create and place the button for admin dashboard under the Welcome label
    button_manage_estab = ctk.CTkButton(app, text="Manage Establishment", width=200, height=200, fg_color="#0000FF")
    button_manage_estab.grid(row=1, column=0, padx= 70, pady=(20, 20), sticky='w')

    button_manage_food = ctk.CTkButton(app, text="Manage Food Items", width=200, height=200, fg_color= "#D2B48C")
    button_manage_food.grid(row=1, column=1, padx = 70, pady=(20, 20), sticky='w')

    button_manage_view = ctk.CTkButton(app, text="View All Entries", width=200, height=200, fg_color="#ADD8E6")
    button_manage_view.grid(row=2, column=0, padx = 70, pady=(20, 20), sticky='w')

    button_manage_any = ctk.CTkButton(app, text="Any", width=200, height=200, fg_color="#A52A2A")
